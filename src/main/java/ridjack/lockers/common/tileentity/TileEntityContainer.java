...
import ridjack.lockers.common.block.BlockContainerlockers;
import ridjack.lockers.common.inventory.ExpandableStackHandler;
...
public abstract class TileEntityContainer extends TileEntity implements INamedContainerProvider, INameable
{
	...
	protected void onOpenOrClose()
	{
		...
		if( block instanceof BlockContainerlockers )
		{
