package io.github.tehstoneman.lockers.common.tileentity;

import java.util.logging.Logger;

import io.github.tehstoneman.lockers.ModInfo;
...
import io.github.tehstoneman.lockers.api.crafting.CraftingSourceTileEntity;
import io.github.tehstoneman.lockers.api.crafting.ICraftingSource;
...
import io.github.tehstoneman.lockers.client.gui.lockersGUIHandler.EnumGui;
import io.github.tehstoneman.lockers.common.inventory.OutputStackHandler;
import io.github.tehstoneman.lockers.config.GlobalConfig;
import io.github.tehstoneman.lockers.inventory.InventoryStacks;
import io.github.tehstoneman.lockers.item.recipe.VanillaStationCrafting;
import io.github.tehstoneman.lockers.misc.FakePlayer;
...
public class TileEntityCraftingStation extends TileEntity implements ITickable, IInventory
{
	...
	{
		currentCrafting = lockersCrafting.findMatchingStationCrafting( crafting );
		if( currentCrafting == null )
