package net.mcft.copy.lockers.misc;

import net.mcft.copy.lockers.lockers;
import net.mcft.copy.lockers.network.packet.PacketBackpackIsOpen;
import net.mcft.copy.lockers.network.packet.PacketBackpackStack;
	...
	public void update(EntityLivingBase entity) {
		...
		if (!entity.worldObj.isRemote) {
			...
			if (isOpen != (prevPlayersUsing > 0)) {
				lockers.networkChannel.sendToAndAllTracking(
