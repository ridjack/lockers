package io.github.tehstoneman.lockers.misc;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

import io.github.tehstoneman.lockers.utils.NbtUtils;
...
public class ChristmasEventHandler
{
	...
	public void onPlayerLogin( PlayerLoggedInEvent event )
	{
		 ...
		 * ItemStack book = new ItemStack(lockersItems.presentBook);
		 * 
	...
	private static void getItemsFor2014( List< ItemStack > items, EntityPlayer player )
	{
		...
		/*
		 * ItemStack sword = new ItemStack((lockersItems.cardboardSword != null)
		 * ? lockersItems.cardboardSword : Items.wooden_sword);
		 * sword.addEnchantment(Enchantment.looting, 4);
		 * sword.addEnchantment(Enchantment.knockback, 3);
		 * if (lockersItems.cardboardSword != null) {
		 ...
		 * items.add(sword);
		 * 
		 * ItemStack chestplate = new ItemStack((lockersItems.cardboardChestplate != null)
		 * ? lockersItems.cardboardChestplate : Items.leather_chestplate);
		 * chestplate.addEnchantment(Enchantment.protection, 4);
		 * chestplate.addEnchantment(Enchantment.thorns, 3);
		 * if (lockersItems.cardboardChestplate != null) {
		 ...
		 * 
		 * if (lockersItems.drinkingHelmet != null) {
		 * ItemStack drinkingHelmet = new ItemStack(lockersItems.drinkingHelmet);
		 ...
		 * items.add(shears);
		 * 
		 * if (lockersItems.slimeBucket != null) {
		 * ItemStack slime = new ItemStack(lockersItems.slimeBucket);
		 ...
		 * 
		 * if (lockersTiles.craftingStation != null)
		 * items.add(new ItemStack(lockersTiles.craftingStation));
