package io.github.tehstoneman.lockers.client.gui;
...
import io.github.tehstoneman.lockers.common.inventory.ContainerCraftingStation;
...
public class GuiCraftingStation extends GuiContainer
{
	...
	{
		fontRendererObj.drawString( lockers.proxy.localize( ModInfo.containerCraftingStation ), 15, 6, 0x404040 );
		fontRendererObj.drawString( lockers.proxy.localize( "container.inventory" ), 8, ySize - 96 + 2, 0x404040 );
