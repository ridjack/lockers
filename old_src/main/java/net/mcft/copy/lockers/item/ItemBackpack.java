...
import net.mcft.copy.lockers.client.model.ModelBackpack;
import net.mcft.copy.lockers.client.model.ModelBackpackArmor;
import net.mcft.copy.lockers.config.GlobalConfig;
import net.mcft.copy.lockers.container.Containerlockers;
import net.mcft.copy.lockers.container.SlotArmorBackpack;
import net.mcft.copy.lockers.content.lockersTiles;
import net.mcft.copy.lockers.inventory.InventoryBackpackEquipped;
import net.mcft.copy.lockers.inventory.InventoryStacks;
import net.mcft.copy.lockers.misc.Constants;
import net.mcft.copy.lockers.misc.EquipmentSlot;
import net.mcft.copy.lockers.misc.PropertiesBackpack;
import net.mcft.copy.lockers.misc.Resources;
import net.mcft.copy.lockers.misc.handlers.KeyBindingHandler;
import net.mcft.copy.lockers.network.packet.PacketBackpackHasItems;
import net.mcft.copy.lockers.tile.TileBackpack;
import net.mcft.copy.lockers.tile.entity.TileEntityBackpack;
import net.mcft.copy.lockers.utils.DirectionUtils;
import net.mcft.copy.lockers.utils.EntityUtils;
import net.mcft.copy.lockers.utils.LanguageUtils;
import net.mcft.copy.lockers.utils.PlayerUtils;
import net.mcft.copy.lockers.utils.RandomUtils;
import net.mcft.copy.lockers.utils.StackUtils;
import net.mcft.copy.lockers.utils.WorldUtils;
...
public class ItemBackpack extends ItemArmorlockers implements ISpecialArmor, IDyeableItem {
	...
	public int getBackpackRows() { return lockers.globalConfig.getInteger(GlobalConfig.backpackRows); }
	...
	public TileBackpack getBlockType() { return lockersTiles.backpack; }
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean advancedTooltips) {
		boolean enableHelpTooltips = lockers.globalConfig.getBoolean(GlobalConfig.enableHelpTooltips);
		...
		// Tell the player to place down and break a backpack to equip it.
			...
			boolean chestplate = lockers.globalConfig.getBoolean(GlobalConfig.backpackChestplate);
			...
			if (!chestplate && lockers.globalConfig.getBoolean(GlobalConfig.enableBackpackOpen)) {
				String str = GameSettings.getKeyDisplayString(KeyBindingHandler.backpackOpen.getKeyCode());
				LanguageUtils.translateTooltip(list, "backpack.openHint", "%KEY%", str);
			}
		}
	...
	public static void setBackpack(EntityLivingBase entity, ItemStack backpack, ItemStack[] contents) {
		boolean setChestplate = (lockers.globalConfig.getBoolean(GlobalConfig.backpackChestplate) ||
	...
	public static boolean canEquipBackpack(EntityPlayer player) {
		return ((getBackpack(player) == null) &&
		        !(lockers.globalConfig.getBoolean(GlobalConfig.backpackChestplate) &&
	...
	public static void updateHasItems(EntityLivingBase entity, PropertiesBackpack backpackData) {
		...
		lockers.networkChannel.sendTo(new PacketBackpackHasItems(hasItems), player);
	...
	public static boolean openBackpack(EntityPlayer player, EntityLivingBase carrier) {
		...
		Container container = new Containerlockers(player, inventory, columns, rows);
	...
	public static boolean onPlaceBackpack(EntityPlayer player, int x, int y, int z, int side) {
		...
		if (!player.worldObj.isRemote && success && player instanceof EntityPlayerMP && lockers.globalConfig.getBoolean(GlobalConfig.backpackChestplate)) {	
