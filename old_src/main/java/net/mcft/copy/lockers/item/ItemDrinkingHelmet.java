package io.github.tehstoneman.lockers.item;

import java.util.ArrayList;
import java.util.List;

import io.github.tehstoneman.lockers.common.item.ItemArmorlockers;
import io.github.tehstoneman.lockers.misc.Resources;
import io.github.tehstoneman.lockers.misc.handlers.KeyBindingHandler;
import io.github.tehstoneman.lockers.utils.LanguageUtils;
...
public class ItemDrinkingHelmet extends ItemArmorlockers
{
	...
	public void addInformation( ItemStack stack, EntityPlayer player, List list, boolean advancedTooltips )
	{
		 ...
		 * else if (lockers.globalConfig.getBoolean(GlobalConfig.enableHelpTooltips))
