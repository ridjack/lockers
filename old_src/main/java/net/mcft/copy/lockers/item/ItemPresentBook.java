...
import io.github.tehstoneman.lockers.misc.ChristmasEventHandler;
import io.github.tehstoneman.lockers.utils.MiscUtils;
...
public class ItemPresentBook extends ItemWritableBook
{
	...
	public ActionResult< ItemStack > onItemRightClick( ItemStack stack, World world, EntityPlayer player, EnumHand hand )
	{
		 ...
		 * " ~~~~~~~~~~~~~\n" + black +
		 * "That's right, you can now make presents in lockers! " +
