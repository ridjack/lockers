...
import net.mcft.copy.lockers.api.crafting.lockersCrafting;
import net.mcft.copy.lockers.api.crafting.IRecipeInput;
import net.mcft.copy.lockers.api.crafting.IStationRecipe;
import net.mcft.copy.lockers.api.crafting.RecipeBounds;
...
import net.mcft.copy.lockers.utils.RenderUtils;
...
public class NEIRecipeHandler extends TemplateRecipeHandler {
	...
	public List<CachedStationRecipe> getRecipes() {
		if (cachedRecipes == null) {
			...
			for (IStationRecipe recipe : lockersCrafting.recipes) {
