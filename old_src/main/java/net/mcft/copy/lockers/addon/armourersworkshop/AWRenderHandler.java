...
import net.mcft.copy.lockers.api.stand.ClientArmorStandPlayer;
import net.mcft.copy.lockers.api.stand.IArmorStand;
import net.mcft.copy.lockers.api.stand.IArmorStandRenderHandler;
