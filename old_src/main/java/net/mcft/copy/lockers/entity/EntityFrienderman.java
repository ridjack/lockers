package net.mcft.copy.lockers.entity;
...
import net.mcft.copy.lockers.network.packet.PacketBackpackTeleport;
...
public class EntityFrienderman extends EntityEnderman {
	...
	public void onLivingUpdate() {
		...
		if (!hasEnderChest && (func_146080_bZ() == Blocks.ender_chest)) {
			...
			worldObj.setBlock(x, y, z, lockersTiles.enderBackpack, RandomUtils.getInt(2, 6), 3);
			WorldUtils.get(worldObj, x, y, z, TileEntityBackpack.class).stack =
					new ItemStack(lockersItems.itemEnderBackpack);
			double px = x + 0.5;
			double py = y + 0.5;
			double pz = z + 0.5;
			lockers.networkChannel.sendToAllAround(
